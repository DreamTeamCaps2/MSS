				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<html:form action="/quan-ly-danh-sach-thuoc-sua-benh" method="post">
										<div class="row form-group">
																	...
																	<logic:iterate name="thuocBenhForm"
																		...
																		<tr>
																			...
																			<td>
																				...
																				<html:link action="/quan-ly-danh-sach-thuoc-sua-benh?maBenhXoa=${maBenh}" >
																	...
																	<logic:iterate name="thuocBenhForm"
																		...
																		<tr>
																			...
																			<td>
																			 ...
																			 <td>
																				<bean:define id="maBenh" name="t" property="maBenh"></bean:define>
																				 <html:link action="/quan-ly-danh-sach-thuoc-sua-benh?maBenhChon=${maBenh}" >
												...
												<div class="row form-group">
								            		<div class="col-lg-3 col-lg-offset-2">
										                <html:link action="/sua-thuoc?kt=${1}" >
