				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<html:form action="/quan-ly-danh-sach-benh-them-thuoc" method="post">
													...
													<div class="col-lg-6">
										            	...
										            	<script>
															$("#select-timThuoc").change(function(){
															   ...
															   window.location.assign("/Caps2/quan-ly-danh-sach-benh-them-thuoc.do?timThuoc="+timThuoc);
															});
														</script>
													</div>
												</div>
																	...
																	<logic:iterate name="benhThuocForm"
																		...
																		<tr>
																			...
																			<td>
																				...
																				<html:link action="/quan-ly-danh-sach-benh-them-thuoc?maThuocXoa=${maThuoc}" >
																	...
																	<logic:iterate name="benhThuocForm"
																		...
																		<tr>
																			...
																			<td>
																			 ...
																			 <td>
																				<bean:define id="maThuoc" name="t" property="maThuoc"></bean:define>
																				 <html:link action="/quan-ly-danh-sach-benh-them-thuoc?maThuocChon=${maThuoc}" >
