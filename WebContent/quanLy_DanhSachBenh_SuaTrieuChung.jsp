				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<html:form action="/quan-ly-danh-sach-benh-sua-trieu-chung" method="post">
													...
													<div class="col-lg-6">
										            	...
										            	<script>
															$("#select-timTrieuChung").change(function(){
															   ...
															   window.location.assign("/Caps2/quan-ly-danh-sach-benh-sua-trieu-chung.do?timTrieuChung="+timTrieuChung);
															});
														</script>
													</div>
												</div>
																	...
																	<logic:iterate name="benhTrieuChungForm"
																		...
																		<tr>
																			...
																			<td>
																				...
																				<html:link action="/quan-ly-danh-sach-benh-sua-trieu-chung?maTrieuChungXoa=${maTrieuChung}" >
																	...
																	<logic:iterate name="benhTrieuChungForm"
																		...
																		<tr>
																			...
																			<td>
																			 ...
																			 <td>
																				<bean:define id="maTrieuChung" name="tc" property="maTrieuChung"></bean:define>
																				 <html:link action="/quan-ly-danh-sach-benh-sua-trieu-chung?maTrieuChungChon=${maTrieuChung}" >
