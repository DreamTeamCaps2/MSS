    ...
    a.fn.pgwSlider = function(n) {
        ...
        var f = function(o, p) {
            if (l.config.maxHeight) {
                if (l.plugin.width() > 480 && o > l.config.maxHeight) {
                    ...
                    if (l.plugin.width() <= 480) {
                        if (o + l.plugin.find(".ps-list").height() >
                            l.config.maxHeight) {
                            o = l.config.maxHeight - l.plugin.find(
                                ".ps-list").height()
                        }
                    }
                }
            ...
            l.resizeEvent = setTimeout(function() {
                var q = ((o - ((l.slideCount - 1) * 6)) / l
                    .slideCount);
                var r = (100 / l.slideCount);
                l.plugin.find(".ps-list > li").css({
                    width: r + "%"
                });
                if (typeof p != "undefined" && p && l.config
                    .maxHeight == null) {
                    if (typeof l.plugin.find(".ps-current")
                        .animate == "function") {
                    ...
                    l.plugin.find(".ps-current > ul > li").each(
                        function() {
                            var s = (a(this).css(
                                        "display") ==
                                    "none") ? false :
        ...
        var e = function() {
            l.plugin.removeClass(l.config.mainClassName).addClass(
                "ps-list");
            l.plugin.wrap('<div class="' + l.config.mainClassName +
                '"></div>');
            ...
            if (l.slideCount == 0) {
                throw new Error(
                    "PgwSlider - No slider item has been found"
                );
                return false
            }
            if (l.config.displayControls && l.slideCount > 1) {
                l.plugin.find(".ps-current").prepend(
                    '<span class="ps-prev"><span class="ps-prevIcon"></span></span>'
                );
                l.plugin.find(".ps-current").append(
                    '<span class="ps-next"><span class="ps-nextIcon"></span></span>'
                );
                l.plugin.find(".ps-current .ps-prev").click(
                    function() {
                        l.previousSlide()
                    });
                l.plugin.find(".ps-current .ps-next").click(
                    function() {
                        l.nextSlide()
                    })
            }
            ...
            l.plugin.find(".ps-list > li").each(function() {
                ...
                if (q.title) {
                    if (a(this).find("span").length == 1) {
                        ...
                        a(this).find("img").after("<span>" +
                            q.title + "</span>")
                    }
                }
                var p = a('<li class="elt_' + o + '"></li>');
                if (q.image) {
                    p.html('<img src="' + q.image +
                        '" alt="' + (q.title ? q.title :
                            "") + '">')
                } else {
                    if (q.thumbnail) {
                        p.html('<img src="' + q.thumbnail +
                            '" alt="' + (q.title ? q.title :
                                "") + '">')
                    }
                } if (q.link) {
                    p.html('<a href="' + q.link + '"' + (q.linkTarget ?
                            ' target="' + q.linkTarget +
                            '"' : "") + ">" + p.html() +
                        "</a>")
                }
                l.plugin.find(".ps-current > ul").append(p);
                if ((l.config.selectionMode == "mouseOver") &&
                    (l.config.transitionEffect == "fading")
                ) {
                    a(this).css("cursor", "default").click(
                        function(r) {
                            r.preventDefault()
            ...
            i(1);
            l.plugin.find(".ps-current > ul > li.elt_1 img").on(
                "load", function() {
                    c();
                    var p = l.plugin.find(
            ...
            if (l.config.touchControls && l.slideCount > 1) {
                l.plugin.find(".ps-current").on("touchstart",
                    function(p) {
                        try {
                            if (p.originalEvent.touches[0].clientX &&
                                l.touchFirstPosition == null) {
                                l.touchFirstPosition = p.originalEvent
                                    .touches[0].clientX
                            }
                        } catch (p) {
                            l.touchFirstPosition = null
                ...
                l.plugin.find(".ps-current").on("touchmove",
                    function(p) {
                        try {
                            if (p.originalEvent.touches[0].clientX &&
                                l.touchFirstPosition != null) {
                                if (p.originalEvent.touches[0].clientX >
                                    ...
                                    if (p.originalEvent.touches[
                                        0].clientX < (l.touchFirstPosition -
                                        50)) {
                ...
                l.plugin.find(".ps-current").on("touchend",
                    function(p) {
                        l.touchFirstPosition = null
                    })
            }
        ...
        var j = function(o) {
            ...
            if (q != "") {
                if (o.link) {
                    q = '<a href="' + o.link + '"' + (o.linkTarget ?
                            ' target="' + o.linkTarget + '"' : "") +
                        ">" + q + "</a>"
                }
                if (typeof l.plugin.find(".ps-caption").fadeIn ==
                    "function") {
                    l.plugin.find(".ps-caption").html(q);
                    l.plugin.find(".ps-caption").fadeIn(l.config.transitionDuration /
                        2)
                } else {
                    l.plugin.find(".ps-caption").html(q);
            ...
            if (l.config.displayControls) {
                if (typeof l.plugin.find(".ps-current > .ps-prev").fadeIn ==
                    "function") {
                    l.plugin.find(
            ...
            if (l.config.adaptiveHeight) {
                var p = l.plugin.find(".ps-current .elt_" + o.id +
                    " img").height();
                f(p, true)
            }
            return true
        ...
        var d = function(r) {
            ...
            l.plugin.find(".ps-list > li.elt_" + r.id).css(
                "opacity", "1");
            q.find("li").not(".elt_" + l.currentSlide).not(".elt_" +
                r.id).each(function() {
        ...
        var k = function(s, v) {
            ...
            if (l.currentSlide == 0) {
                ...
                l.plugin.find(".ps-list > li.elt_1").css("opacity",
                    "1");
                j(s)
            } else {
                ...
                q.css("position", "absolute").css("left", t).css(
                    "opacity", 1).show().animate({
                    left: 0
                }, l.config.transitionDuration, function() {
                    q.css("position", "").css("left", "").css(
                        "z-index", 2).show();
                    l.transitionInProgress = false;
                    l.plugin.find(".ps-list > li").css(
                        "opacity", "0.6");
                    l.plugin.find(".ps-list > li.elt_" + s.id)
                        .css("opacity", "1");
                    j(s)
                })
            }
        ...
        var i = function(o, q, r) {
            ...
            if (typeof p == "undefined") {
                throw new Error("PgwSlider - The element " + o +
                    " is undefined");
                return false
            }
            ...
            if (typeof l.plugin.find(".ps-caption").fadeOut ==
                "function") {
                l.plugin.find(".ps-caption, .ps-prev, .ps-next").fadeOut(
                    l.config.transitionDuration / 2)
            } else {
            ...
            if (typeof o != "undefined") {
                l.plugin.find(".ps-list > li").each(function() {
                    a(this).attr("style", null).removeClass()
                        .css("cursor", "").unbind("click").unbind(
                            "mouseenter");
                    a(this).find("a").css("cursor", "");
                    a(this).find("img").attr("style", null)
                });
                l.plugin.find(".ps-list").addClass(l.config.mainClassName)
                    .removeClass("ps-list");
