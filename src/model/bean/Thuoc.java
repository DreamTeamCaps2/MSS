...
public class Thuoc {
	...
	private int maThuoc, maNhomThuoc, luotXem, maLoaiThuoc;
	private String tenThuoc, hinhAnh, congThuc, tenKhoaHoc, dieuChe, 
		tinhChat, tacDung, chiDinh, baoQuan, thanTrong, DDH;
